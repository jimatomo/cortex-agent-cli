...
- [ ] Ensure all user-facing errors print a clear action hint (`use --debug for details`, `check your connection settings`, etc.)
- [ ] Audit for swallowed errors (ignored `err` return values)
